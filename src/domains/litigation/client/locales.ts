...
export const zh: LitigationKey = {
  ...
  // timeline
  'timeline.empty': '暂无时间轴日程。点击「添加日程」记录立案、开庭、送达等节点。',
  'timeline.addEvent': '添加日程',
  'timeline.edit': '编辑',
  'timeline.delete': '删除',
  'timeline.complete': '已完成',
  'timeline.reopen': '重新打开',
  'timeline.titlePlaceholder': '日程名称，如：第一次开庭',
  'timeline.remindDaysPlaceholder': '提醒（天数）',
  'timeline.save': '保存',
  'timeline.cancel': '取消',
  // schedule
  'schedule.title': '日程',
  'schedule.empty': '暂无日程。时间轴日程、任务期限与关键日期会自动汇入此处。',
  'schedule.urgent': '临近',
  // import
  ...
  'import.run': '开始导入',
  'import.running': '导入中…',
  'import.result': '导入完成：新增 {added} 个案件，更新 {updated} 个，导入 {events} 个时间轴日程。',
...
export const en: LitigationKey = {
  ...
  // timeline
  'timeline.empty': 'No timeline schedules yet. Add filing, hearing, service…',
  'timeline.addEvent': 'Add schedule',
  'timeline.edit': 'Edit',
