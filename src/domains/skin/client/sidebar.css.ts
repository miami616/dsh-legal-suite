...
/* ═══ 右侧标签页（对话/轨迹）：分段控件 ═══ */
html[data-agentlex-theme] :is([data-slot="conversation"], [data-slot="main.conversation"]) [role="tablist"] {
  display: flex;
  align-items: center;
  gap: 2px;
  padding: 3px;
...
html[data-agentlex-theme] :is([data-slot="conversation"], [data-slot="main.conversation"]) [role="tab"] {
  border: 0;
  border-radius: 7px;
  background: transparent;
  color: var(--dsw-alias-label-tertiary);
...
html[data-agentlex-theme] :is([data-slot="conversation"], [data-slot="main.conversation"]) [role="tab"]:hover {
  color: var(--dsw-alias-label-primary);
}
html[data-agentlex-theme] :is([data-slot="conversation"], [data-slot="main.conversation"]) [role="tab"][aria-selected="true"] {
...
/* ═══ 会话气泡与输入区 ═══ */
html[data-agentlex-theme] :is([data-slot="conversation"], [data-slot="main.conversation"]) [class*="bubble"] {
  border-radius: 14px;
  border: 1px solid var(--dsw-alias-border-l1);
...
/* 代码块描边与圆角统一 */
html[data-agentlex-theme] :is([data-slot="conversation"], [data-slot="main.conversation"]) pre[class*="code"],
html[data-agentlex-theme] :is([data-slot="conversation"], [data-slot="main.conversation"]) [class*="codeBlock"] {
  border-radius: 10px;
}

/* ═══ 新会话 Hero ═══ */
html[data-agentlex-theme] :is([data-slot="conversation"], [data-slot="main.conversation"]) [class*="headlineText"],
html[data-agentlex-theme] :is([data-slot="conversation"], [data-slot="main.conversation"]) [class*="previewBadge"] {
  display: none !important;
}
html[data-agentlex-theme] :is([data-slot="conversation"], [data-slot="main.conversation"]) [class*="headline"]:not([class*="headlineText"]):not([class*="previewBadge"]) {
