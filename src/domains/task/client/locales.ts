...
const zh: TaskKey = {
  ...
  'mobile.task.readonly': '该任务来自{{source}}，可在此切换状态；标题/详情等编辑请在其对应面板中操作。',
...
const en: TaskKey = {
  ...
  'mobile.task.readonly': 'This task belongs to {{source}} — you can toggle its status here; edit title/detail in that panel.',
