...
export interface SessionMetadata {
    ...
    /** AgentLex: business-module key that spawned this session (see utils/businessModules.ts) */
    businessKey?: string;
...
export async function updateSession(
    ...
    updates: {
        ...
        /** AgentLex 业务归属(BusinessBinding key)。会话从业务模块启动时盖一次戳。
         *  纯元数据,服务端不 stamp configSnapshotAt、不 bump recency。null → 清除。 */
