      ...
      <div className="max-w-6xl mx-auto px-8 py-7 space-y-6">
        ...
        <header>
          ...
          <div className="flex items-baseline gap-3 mt-4 flex-wrap">
            <span className="text-xl font-extrabold tracking-[0.01em] text-[var(--ink-muted)]" style={{ fontFamily: "-apple-system, 'SF Pro Text', 'PingFang SC', 'Microsoft YaHei', sans-serif", fontVariantNumeric: 'tabular-nums' }}>{idHead}<b className="text-[var(--ink)]">{idTail}</b></span>
