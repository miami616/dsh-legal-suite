...
/**
 * AgentLex generic proxy fetch (browser / headless-serve mode).
 * In browser mode (web serve / Vite dev) the native fetch path is used and
 * CORS is handled by the serving origin; in Tauri mode the request goes
 * through the Rust proxy.
 */
